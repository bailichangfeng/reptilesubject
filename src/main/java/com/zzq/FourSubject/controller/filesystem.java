...
public class filesystem {
    public static void main(String[] args) throws Exception{
        List<shopattributes> listattributes = basic();
        writeFileContext(listattributes,"E:\\四级课题\\data.txt");
    }
...
//            }
        ...
        public static List<shopattributes> basic(){
        ...
        public static List<shopattributes> geturl(List<String> USER_AGENT_LIST,String city,List<shopattributes> listattributes,List<shopbeans> list){
            Document doc = null;
     ...
     * @throws Exception
     */
    public static void writeFileContext(List<shopattributes>  strings, String path) throws Exception {
        ...
        for (shopattributes shopattributes:strings){
            ...
            writer.write(shopattributes.getRefinedScore1()+",");
            writer.write(shopattributes.getRefinedScore2()+",");
            writer.write(shopattributes.getRefinedScore3()+",");
